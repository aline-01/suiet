...
arr=['آران و بيدگل','باغ ابریشم','اردستان','اصفهان','باغ بهادران','تيران','چادگان','خميني شهر','خوانسار','دولت آباد','دهاقان','زرين شهر','زیبا شهر','سميرم','سپاهان شهر','شاهين شهر','شهرضا','فريدن','فريدون شهر','فلاورجان','فولاد شهر','قهدریجان','كاشان','گلدشت','گلپايگان','مباركه','ملک شهر','نايين','نجف آباد','نطنز','هرند'];
