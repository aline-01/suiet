...
if (isset($_POST["submit"])) {
    ...
    if (empty($phone_number)) {
        ...
        $uniq_number = $functions->check_uniq_number($phone_number);
        if ($uniq_number == true) {
            //do nothing
        }else {
    ...
    if (empty($errors)) {
        ...
        if ($query_insert->rowCount() > 0) {
            ...
            $_SESSION["user_login"] = array($phone_number,$password);
         ...
         <div class="col-12 col-lg-6">
             <div class="card border-0 login">
                 ...
                 <div class="card-footer d-flex justify-content-center align-items-center ">
                     ...
                     <a href="http://localhost:2211/?page_id=25" class="text-success font-sm mb-4 mt-2 mr-2 align-middle"> ورود در سایت آگهی املاک سوئیت</a>
                 </div>
             </div>
