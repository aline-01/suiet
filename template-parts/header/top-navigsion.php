...
<div class="header-bottom bg-white iransans">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light ">
            ...
            {
                echo(' <div class="navbar-collapse collapse justify-content-center" id="navbar-top"> please add menu to menu location "Header menu" from navigation in admin panel  </div>');
            }
